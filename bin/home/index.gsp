...
<body>
    ...
    <div id="headingBar" class="heading-bar">
        <h3 style="width:100%;" id="searchHeader"><g:message code="home.index.body.title"
                                                             default="Search for records in"/> ${raw(hubDisplayName)}</h3>
    </div>
        ...
        <div class="col-sm-12 col-md-12">
            <div class="tabbable">
                <ul class="nav nav-tabs" id="searchTabs">
                    <li role="presentation" class="active"><a id="t1" href="#simpleSearch" data-toggle="tab"><g:message code="home.index.navigator01"
                                                                                     default="Simple search"/></a></li>
                    <li role="presentation"><a id="t2" href="#advanceSearch" data-toggle="tab"><g:message code="home.index.navigator02"
                                                                                      default="Advanced search"/></a></li>
                    <li role="presentation"><a id="t3" href="#taxaUpload" data-toggle="tab"><g:message code="home.index.navigator03"
                                                                                   default="Batch taxon search"/></a></li>
                    <li role="presentation"><a id="t4" href="#catalogUpload" data-toggle="tab"><g:message code="home.index.navigator04"
                                                                                      default="Catalogue number search"/></a>
                    </li>
                    <li role="presentation"><a id="t5" href="#spatialSearch" data-toggle="tab"><g:message code="home.index.navigator05"
